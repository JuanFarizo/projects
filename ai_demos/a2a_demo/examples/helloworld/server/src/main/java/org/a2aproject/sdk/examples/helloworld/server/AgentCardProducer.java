    ...
    public AgentCard agentCard() {
        ...
        return AgentCard.builder()
                ...
                .skills(Collections.singletonList(AgentSkill.builder()
                        ...
                        .description("Given a description of a production incident, investigates and proposes a likely root cause and next steps")
                        .tags(List.of("incident", "diagnostics"))
                        .examples(List.of("Customers cannot complete payments since 14:00"))
                        .build()))
                .build();
    }

...
@Service
public class PatagoniaPdfExtractor implements PdfExtractor {
    private static final DateTimeFormatter DATE_FORMAT = DateTimeFormatter.ofPattern("d/MM/yy");
    private static final Pattern DATE_LINE = Pattern.compile("^(\\d{1}/\\d{2}/\\d{2})\\s+(.*)$");

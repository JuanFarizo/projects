...
export function priceWithMonthlyDiscount(ratePerHour, numDays, discount) {
  ...
  let ratePerHourWithDiscount = ratePerHour * (1 - discount);
  return Math.ceil((daysWithoutDiscount * WORKING_HOURS_PER_DAY * ratePerHour) + (daysWithDiscount * ratePerHourWithDiscount * WORKING_HOURS_PER_DAY));
}
